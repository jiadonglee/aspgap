...
if __name__ == "__main__":
    ...
    aspcap  = ASPCAP_error(data_dir+tr_file, total_num=TOTAL_NUM, device=device)
    # aspcap_val = ASPCAP(data_dir+val_file, device=device)
    train_size = int(0.75*len(aspcap))
    ...
    enc_seq_len = 512 # length of input given to encoder. Can have any integer value.
    ...
    torch.save(model.state_dict(), data_dir+"model/ap_prlx_trsfm_error221020.pt")
